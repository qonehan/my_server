...
3. 두괄식으로 작성: 핵심 요점을 먼저 말하고 부연 설명
4. TTS가 읽을 대사만 작성 - 지문, 설명, 괄호, 장면번호 등 절대 금지
5. 한 장면 = 한 문장 = 하나의 이미지
6. 자연스러운 구어체로 작성
...
❌ 잘못된 예시:
"장면1: 인공지능의 발전 (설명)"
"인공지능은 우리 삶을 크게 바꾸고 있어요. 오늘은 그 변화를 살펴볼게요." (2문장 금지)

✅ 올바른 예시:
"인공지능은 우리 삶을 크게 바꾸고 있어요."
---
"오늘은 그 변화를 함께 살펴볼게요."
---
"첫 번째로 의료 분야의 변화입니다."
...
⚠️ 중요: 반드시 8-12개 장면을 작성하고, 각 장면은 한 문장만, "---"로 구분하세요.`
  },
  planning: {
    name: '[2층] 자막 & 이미지 컨셉',
    status: 'pending',
